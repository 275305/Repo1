...
public class JourneyScreenTwoUpdate extends ReusableActionsUpdate{
 ...
 // Initializing the Objects
 	public JourneyScreenTwoUpdate(WebDriver driver)
 	{
 ...
 click(dateOfBirth);
 	...
 	public static void selectByDropdown() throws Exception {
 		PageFactory.initElements(driver, JourneyScreenTwoUpdate.class);
