...
public class MakeMyTripTest {
	...
	MakeMyTripPage homepage;

	@BeforeClass
	public void initPage() {
		final String WEB_Driver_PATH=System.getProperty("user.dir");
		System.setProperty("webdriver.chrome.driver", WEB_Driver_PATH+"\\lib\\chromedriver.exe");
